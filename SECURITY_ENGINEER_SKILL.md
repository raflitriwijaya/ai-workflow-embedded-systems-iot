...
- **Provides:** #threat-model assessment of security-relevant research findings using STRIDE (Spoofing, Tampering, Repudiation, Information Disclosure, Denial of Service, Elevation of Privilege) methodology, delivered within 10 business days of receipt of the Researcher's Pre-Transfer Security Review briefing document. Security requirements and constraints for experimental design: encryption standards (AES-256-GCM — Advanced Encryption Standard with 256-bit key in Galois/Counter Mode, ChaCha20-Poly1305), secure boot chain implications, hardware root-of-trust requirements, key management protocols, and data classification requirements per organizational policy. Guidance on secure handling of sensitive research data: storage encryption requirements (AES-256 at rest), access logging expectations, data minimization principles, and PII (Personally Identifiable Information) masking protocols where research data intersects with human-subject or user data. Feedback on the security feasibility of proposed novel architectures: identification of architectural elements that would require additional security controls in production, assessment of whether proposed approaches align with the organizational security baseline, and flagging of any research directions that are fundamentally incompatible with the security baseline. Quarterly threat landscape briefings incorporating research-stage insights: emerging #attack-surface categories relevant to active research directions, newly discovered vulnerability classes in related embedded/IoT (Internet of Things) domains, and updates to the adversary TTP (Tactics, Techniques, and Procedures) profile for the organization's deployment context. Updated security requirements for experimental design delivered within 15 business days of any significant organizational security baseline change

- **Requires:** Technology Transfer Packs from the Researcher with flagged #security-relevant findings and explicit identification of potential #attack-surface elements, categorized by type (#connectivity, #data-handling, #compute-architecture, #sensor-physics). Pre-Transfer Security Review briefing documents for each research finding with #connectivity, #data-handling, or #compute-architecture implications, submitted ≥2 weeks (10 business days) before the scheduled Technology Transfer Pack handoff, including: identified attack-surface elements, novel data types with #privacy implications, security assumptions made during experimental design, and known limitations of the research prototype from a security standpoint. Early-stage notification of research direction changes that introduce new #attack-surface elements, delivered within 5 business days of the direction change, with sufficient detail for the Security Engineer to scope the threat assessment. Characterization data for novel hardware security mechanisms under investigation: PUF (Physical Unclonable Function) response characteristics, novel side-channel resistant transducer designs, experimental tamper-detection materials, and hardware-based entropy sources evaluated in research. Quarterly update on active research directions for threat landscape alignment, including: active research hypotheses with #security-relevant implications, new experimental modalities under investigation, and anticipated technology transfer candidates in the next 6–12 months

- **Cadence:** Pre-Transfer Security Review: assessment delivered within 10 business days of the Researcher's briefing submission; must be completed before Technology Transfer Pack finalization. Quarterly Research-Security Threat Landscape Review: joint session with the Researcher, first Tuesday of each calendar quarter (January, April, July, October); Security Engineer presents updated threat landscape, adversary TTP profile, and emerging vulnerability classes; a joint summary document is produced and distributed to the Head of Research and CTO within 5 business days. Ad hoc consultation — research direction change: Security Engineer acknowledges notification within 3 business days; provides initial security scoping assessment within 10 business days for standard complexity or 20 business days for high complexity (novel wireless modality or unconventional compute architecture). Security requirements for experimental design: updated annually (aligned with the organizational fiscal year security baseline review) or upon significant organizational security baseline change (e.g., adoption of a new cryptographic standard, change in data classification policy), whichever comes first; updated requirements pushed to the Researcher within 15 business days of the baseline change
