...
### 6.15 [[BUSINESS_CONSULTANT_SKILL|Business Consultant]]

- **PO/TPM provides:** Product backlog status and roadmap timeline; engineering velocity estimates and release forecasts; feature-completion status for GTM (Go-to-Market) planning; and escalation of any scope changes with business impact.
- **PO/TPM requires:** Business-value ranking of backlog features (revenue impact, market differentiation, customer priority); market-window analysis to inform sprint and release prioritization; GTM readiness inputs (certification status, pricing finalization, sales-channel readiness); and customer-feedback synthesis from market research and client discovery.
- **Cadence:**
  - Weekly Business-Product Sync: 30-minute standing meeting every Monday #cadence #market-product-alignment #interface-contract. The [[BUSINESS_CONSULTANT_SKILL|Business Consultant]] provides market-intelligence updates, competitive moves, customer feedback, and any urgent business-constraint changes; the PO/TPM provides product status, milestone progress, and any technical-feasibility findings that may affect market commitments. Output: updated shared action-items log.
  - Monthly Business-Product Alignment Review: first Wednesday of each month, 90 minutes #cadence. Comprehensive review of product roadmap vs. market-window alignment, feature prioritization against customer value and willingness-to-pay data, BOM (Bill of Materials) cost trends vs. target price point, competitive positioning, and any business-constraint changes. Output: updated Business-Product Alignment document.
  - Quarterly Business-Product Strategy Session: second Thursday of January, April, July, October, half-day #cadence. Deep-dive on market evolution and emerging opportunities, product-portfolio strategy and investment prioritization, make-vs-buy and partnership strategy, pricing and monetization model review, and long-range (12–36 month) product-vision alignment. Output: updated Product Strategy Document.
  - Market Requirement Change Notification: the Business Consultant notifies the PO/TPM of significant market-requirement changes within 2 business days of confirmed intelligence #synchronization; the PO/TPM provides an initial product-impact assessment within 5 business days.
  - Pre-Sprint Backlog Input: the Business Consultant provides market-prioritized feature requests ≥3 business days before sprint planning #synchronization; the PO/TPM incorporates them into backlog prioritization and reports what was accepted/deferred and why within 1 business day after sprint planning.
  - Release Go-to-Market Readiness Review: joint GTM readiness review 2 weeks before each production release #cadence. The Business Consultant confirms pricing approved, sales team trained, marketing materials ready, and customer communication prepared; the PO/TPM confirms release scope finalized, QA (Quality Assurance) sign-off complete, and OTA (Over-the-Air) rollout plan approved.
  ...
  - **Co-location During Planning and Early Development:** during the Planning stage and the first 2 weeks of the Development stage, the [[BUSINESS_CONSULTANT_SKILL|Business Consultant]] co-locates (virtual or physical) with the PO/TPM for daily stand-up participation and is available for ad hoc consultation within 2 hours during business hours, ensuring market requirements are clarifiable during backlog refinement, business-constraint changes are surfaced to sprint planning in real time, and feature acceptance criteria can be validated against market expectations before Development commits. #co-location #BIZ-PO-cadence #Planning #Development #business-interface #HR-2
