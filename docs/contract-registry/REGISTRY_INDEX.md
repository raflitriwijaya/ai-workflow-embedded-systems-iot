...
> **Batch 1** = rows 1–15 (`FW↔BACK-001` … `PO↔ALL-RELEASE-001`); **Batch 2** = rows 16–29 (`DATA↔BACK-INGEST-001` … `ARCH↔PO-001`); **Batch 3** = rows 30–44 (`ARCH↔HW-001` … `BACK↔SEC-001`); **Batch 4** = rows 45–58 (`DEVOPS↔QA-001` … `QA↔BIZ-001`). 58 of 91 contracts converted.
