...
|OTA Strategy Specification|A/B partitioning, signing, and rollback policy|Firmware, DevOps, Security|Markdown|SemVer; major bump on partition/scheme change|
...
- **Template fields:** Title; Status; Context; Decision; Consequences; Alternatives Considered; Related ADRs.
