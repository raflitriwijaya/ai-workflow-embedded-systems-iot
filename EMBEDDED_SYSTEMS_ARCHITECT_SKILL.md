...
- **Decision Record:** All ARB decisions are documented as ARB Decision Records (same format as ADRs, tagged #ARB). ARB decisions that would normally require an ADR are cross-referenced from the ADR repository
